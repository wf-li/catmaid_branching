#connectivity_processessing 2022-01-21
import pymaid
import pandas as pd
            ...
            for neur in catNeur:
                ...
                for i in range(len(nr_subtree)):
                    ...
                    for node in filt_conns2.node_id:                    
                        lengthTemp.append(bf.get_norm_length(node,catNeurnumpy,trunk))
                        distTemp.append(bf.get_norm_dist(node,catNeurnumpy,trunk))
